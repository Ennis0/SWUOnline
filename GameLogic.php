  ...
  switch($phase) {
    case "FINDINDICES":
      ...
      switch($parameter) {
        ...
        case "TARGETSBYTYPE": $rv = GetIndicesForTargetType($player, $subparam); break;
      ...
      switch ($parameterArr[0])
      {
        ...
        case "DEALDAMAGE":
          ...
          if($targetArr[0] == "MYALLY" || $targetArr[0] == "THEIRALLY") {
            ...
            if($destroyed) {
              if($isAttackTarget || $isAttacker) CancelAttack();
              return "";
            }
          } else {
    ...
    case "OP":
      ...
      switch($parameter)
      {
        ...
        case "DISCARDCAPTIVE":
          ...
          return $lastResult;
        case "PLAYCARD":
          PlayCard($paramArr[1], $paramArr[2], -1, -1);
          return $lastResult;
        case "PLAYCARDSKIPPREPAYMENT":
          PlayCard($paramArr[1], $paramArr[2], true);
          return $lastResult;
    ...
    case "GETTARGETOFATTACK":
      GetTargetOfAttack($lastResult, $player);
      return $lastResult;
    case "STARTTURN":
      StartTurn();
      return $lastResult;
    ...
    case "MULTIDISTRIBUTEDAMAGE":
      ...
      return $lastResult;
    case "WHICHPLAYERSTRIGGERS":
      PrependDecisionQueue("BRINGPLAYERSTRIGGERSFORWARD", $player, "-");
      PrependDecisionQueue("BUTTONINPUT", $player, "Yourself,Opponent");
